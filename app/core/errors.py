...
class ErrorCode(StrEnum):
    ...
    TOP_UP_AMOUNT_OUT_OF_RANGE = "TOP_UP_AMOUNT_OUT_OF_RANGE"
    TOP_UP_LIFETIME_LIMIT_EXCEEDED = "TOP_UP_LIFETIME_LIMIT_EXCEEDED"
    DATABASE_UNAVAILABLE = "DATABASE_UNAVAILABLE"
    MARKET_NOT_TRADABLE = "MARKET_NOT_TRADABLE"
    INSUFFICIENT_CASH_BALANCE = "INSUFFICIENT_CASH_BALANCE"
    INSUFFICIENT_HOLDING_QUANTITY = "INSUFFICIENT_HOLDING_QUANTITY"
...
ERROR_STATUS_CODES: Final[Mapping[ErrorCode, int]] = MappingProxyType(
    {
        ...
        ErrorCode.TOP_UP_AMOUNT_OUT_OF_RANGE: status.HTTP_400_BAD_REQUEST,
        ErrorCode.TOP_UP_LIFETIME_LIMIT_EXCEEDED: status.HTTP_400_BAD_REQUEST,
        ErrorCode.DATABASE_UNAVAILABLE: status.HTTP_503_SERVICE_UNAVAILABLE,
        ErrorCode.MARKET_NOT_TRADABLE: status.HTTP_400_BAD_REQUEST,
        ErrorCode.INSUFFICIENT_CASH_BALANCE: status.HTTP_400_BAD_REQUEST,
        ErrorCode.INSUFFICIENT_HOLDING_QUANTITY: status.HTTP_400_BAD_REQUEST,
